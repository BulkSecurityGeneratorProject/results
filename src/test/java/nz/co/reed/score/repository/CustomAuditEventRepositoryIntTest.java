...
import nz.co.reed.score.config.audit.AuditEventConverter;
import nz.co.reed.score.domain.PersistentAuditEvent;
...
import static nz.co.reed.score.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
